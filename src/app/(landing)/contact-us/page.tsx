...
//           </Typography>
//           <Box sx={{ mt: 2 }}>
//             <Link href="/privacy-policy" variant="body2" component={NextLink} sx={{ color: "white", mx: 2 }}>
//               Privacy Policy
//             </Link>
//             <Link href="/terms-of-use" variant="body2" component={NextLink} sx={{ color: "white", mx: 2 }}>
//               Terms of Use
//             </Link>
//             <Link href="/contact-us" variant="body2" component={NextLink} sx={{ color: "white", mx: 2 }}>
//               Contact Us
//             </Link>
//           </Box>
//         </Container>
